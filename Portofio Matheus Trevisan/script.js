...
function toggleMenu() {
  ...
  function animarTrimestre(event, trimestre) {
    event.preventDefault(); 
  
    const imagem = document.querySelector('.imagemDeLinguagens');
    const trimestres = document.querySelector('.trimestres');
    const titulo = document.querySelector('.tituloDeLinguagens');
  
    imagem.style.animation = 'subirImagem 0.8s forwards';
    trimestres.style.animation = 'subirImagem 0.8s forwards';
    titulo.style.animation = 'subirImagem 0.8s forwards';
  
    setTimeout(() => {
      window.location.href = `linguagens${trimestre}.html`;
    }, 800); 
  }

  function abrirModal(numero) {
    document.getElementById(`modal${numero}`).style.display = "block";
  }
...
const trimestres = document.querySelectorAll('.textoDosTrimestres');
const imagemDeNatureza = document.querySelector('.imagemDeNatureza');
const baixo = document.querySelector('.baixo');


function animarTrimestre(trimestre) {
  const imagem = document.querySelector('.imagemDeNatureza');
  const trimestres = document.querySelector('.trimestres');
  const titulo = document.querySelector('.tituloNatureza');
  ...
  setTimeout(() => {
    window.location.href = `natureza${trimestre}.html`;
  }, 800);
}
